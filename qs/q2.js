  ...
  render() {
    return (
      <View style={styles.panel}>
        <Text style={styles.greetingBox}>When east india company came into existance, England was ruled by</Text>
         <VrButton style={styles.greetingBox} onClick = { this.clickA} >
              <Text style={styles.greeting}>Hanorvains</Text>
          </VrButton>
          <VrButton style={ styles.greetingBox } 
            onClick = {this.clickB} >
              <Text style={styles.greeting}>Stuarts</Text>
          </VrButton>
          <VrButton style={styles.greetingBox} onClick = { this.clickC} >
              <Text style={styles.greeting}>Normans</Text>
          </VrButton>
