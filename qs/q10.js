  ...
  render() {
    ...
    return (
      <View style={styles.panel}>
        <Text style={styles.greetingBox}>who first translated Bhagvad Gita to English</Text>
         <VrButton style={styles.greetingBox} onClick = { this.clickA} >
              <Text style={styles.greeting}>William Jones</Text>
          </VrButton>
          <VrButton id='B' style={ styles.greetingBox } 
            onClick = {this.clickB} >
              <Text style={styles.greeting}>Charles Wilkins</Text>
          </VrButton>
          <VrButton style={styles.greetingBox} onClick = { this.clickC} >
              <Text style={styles.greeting}>Alexander Cunningham</Text>
          </VrButton>
          <VrButton style={styles.greetingBox} onClick = { this.clickD} >
              <Text style={styles.greeting}>John Marshall</Text>
          </VrButton>
